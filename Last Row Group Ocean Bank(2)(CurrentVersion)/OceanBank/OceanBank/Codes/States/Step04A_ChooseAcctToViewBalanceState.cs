...
namespace OceanBank
{
    class ChooseAcctToViewBalanceState : State
    {
        public ChooseAcctToViewBalanceState(GUIforATM mainForm, string language) : base(mainForm, language)
        {
            ...
            {
                bigDisplayLBL.Text = "Sila pilih akaun untuk melihat baki";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
            ...
            {
                bigDisplayLBL.Text = "இருப்புகளைப் பார்வையிடுவதற்கு கணக்கைத் தேர்ந்தெடுக்கவும்";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
        ...
        public override State handleLeft1BTNClick()
        {
            ...
            if (left1BTN.Text != "")
            {
                nextStep = new ViewBalanceState(mainForm, language, left1BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft2BTNClick()
        {
            ...
            if (left2BTN.Text != "")
            {
                nextStep = new ViewBalanceState(mainForm, language, left2BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft3BTNClick()
        {
            ...
            if (left3BTN.Text != "")
            {
                nextStep = new ViewBalanceState(mainForm, language, left3BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft4BTNClick()
        {
            ...
            if(left4BTN.Text != "")
            {
                nextStep = new ViewBalanceState(mainForm, language, left4BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleRight1BTNClick()
        {
            ...
            if(right1BTN.Text != "")
            {
                nextStep = new ViewBalanceState(mainForm, language, right1BTN.Text);
            }
            return nextStep;
        }
