...
namespace OceanBank
{
    class ChooseAcctToDepositState : State
    {
        public ChooseAcctToDepositState(GUIforATM mainForm, string language) : base(mainForm, language)
        {
            ...
            {
                bigDisplayLBL.Text = "Sila pilih akaun untuk deposit ke";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
            ...
            {
                bigDisplayLBL.Text = "டெபாசிட் செய்ய கணக்கைத் தேர்ந்தெடுக்கவும்";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
            ...
            {
                bigDisplayLBL.Text = "Please select account to deposit to";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
        ...
        public override State handleLeft1BTNClick()
        {
            ...
            if (left1BTN.Text != "")
            {
                nextStep = new InsertCashDepositState(mainForm, language, left1BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft2BTNClick()
        {
            ...
            if (left2BTN.Text != "")
            {
                nextStep = new InsertCashDepositState(mainForm, language, left2BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft3BTNClick()
        {
            ...
            if (left3BTN.Text != "")
            {
                nextStep = new InsertCashDepositState(mainForm, language, left3BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleLeft4BTNClick()
        {
            ...
            if (left4BTN.Text != "")
            {
                nextStep = new InsertCashDepositState(mainForm, language, left4BTN.Text);
            }
            return nextStep;
        }
        ...
        public override State handleRight1BTNClick()
        {
            ...
            if (right1BTN.Text != "")
            {
                nextStep = new InsertCashDepositState(mainForm, language, right1BTN.Text);
            }
            return nextStep;
        }
